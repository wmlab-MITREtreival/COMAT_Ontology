def change_verb(verb):
    # install, survey,'detect','detects','download', 'navigate','locate','issue','move','take','click','alerts','entrench','exfiltrate', 'deploy', 'putfile','compose','create', 'creates','copy','copies','save','saved','saves','allocate','assign', 'drop','drops'
    v_unlink = ['delete', 'clear', 'remove', 'erase', 'wipe','purge','expunge']
    ...
    v_exec = [ 'use', 'execute', 'executed', 'run', 'ran', 'launch', 'call', 'perform', 'invoke', 'inject', 'implant', 'open', 'opened','target','resume','exec']
    ...
    v_receive = ['receive','accept','get','gets', 'retrive']
