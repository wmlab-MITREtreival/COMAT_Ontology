...
must_ttp_dict = {
    ...
    't1053' : ['scheduled task', 'task scheduler'],
    ...
    't1562' : ['disable winnows defender','disabling Windows Defender','disabled Windows Defender','AV software','stop anti-malware','stopped anti-malware','terminate antimalware process','disable security product','disabled security product','disable anti-virus','disabled event log','disable event log'],
    ...
    # TA0007	Discovery
    't1016' : ['list of hosts or ip addresses','list of ip addresses','ip address of the victim','netmon.exe','ipconfig', 'ifconfig'],
    't1057' : ['list of processes','list running processes','list of running processes', 'show running process','Running processes','tasklist','names of running process','list process', 'ProcessList'],
    't1083' : ['list of files','list file', 'browse file systems'],
    't1518' : ['antivirus software','antivirus process'],
    't1082' : ['os version','system information','operating system version','version of the operating system'],
    ...
    't1113' : ['screenshot', 'screen captur', 'screen shot'],
...
if __name__=='__main__':
    doc = "tood screenshot domain group rdp Disk Wipe."
